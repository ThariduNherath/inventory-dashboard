            ...
            <form action={createProduct} className="space-y-8">
              ...
              <div className="group">
                ...
                <div className="relative">
                  <svg
                    className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-purple-500 transition-colors"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <div className="flex gap-4 pt-6 border-t border-gray-200">
                ...
                >
                  <svg
                    className="w-5 h-5 text-gray-500 group-hover:-translate-x-1 transition-transform duration-300"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
